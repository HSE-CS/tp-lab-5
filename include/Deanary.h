...
class Deanary {
 private:
    ...
    bool isIdUnique(unsigned int id, std::vector<Student*> *studentsVec = nullptr);
    Student* createStudent(const std::string& fio, std::vector<Student*> *studentsVec = nullptr);
 ...
 public:
    ...
    void addMarksToAll();
    void getStatistics();
    void moveStudent(const unsigned int id, const std::string& from, const std::string& to);
    void moveStudent(const std::string& fio, const std::string& from, const std::string& to);
