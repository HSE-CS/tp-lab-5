...
int main() {
  ...
  parse_groups(titles, specs, "C:\\Users\\Marina\\CLionProjects\\tp-lab-5\\data\\groups.txt");
  parse_students(fios, ids, "C:\\Users\\Marina\\CLionProjects\\tp-lab-5\\data\\students.txt");
  Deanary mse;
